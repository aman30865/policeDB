<?php
    ...
    $firs = mysqli_fetch_array($queryfir, MYSQLI_ASSOC);
        ...
        header("Location: https://aman-prakash2.000webhostapp.com/");
    }
...
<head>
    ...
    <body>
        ...
        <form method="post" action="profile.php">
                    ...
                    <button class="btn btn-info"><a style="color:white" href="https://aman-prakash2.000webhostapp.com/">BACK</a></button>
                </form>
